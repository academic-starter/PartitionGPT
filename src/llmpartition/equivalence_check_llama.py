...
def eq_check(contract_name, func_name, index, all_extern_deps_code, code):
    out_dir = "./eq_checks-llama3.1_latest"
    ...
    cmd = ["./solidity/build/solver/solver", "eq_check", "-files", sol_file, "-m", contract_name, "-functions", func_name, func_name+"_new"]
...
work_dir = "./advanced-llama3.1_latest"
