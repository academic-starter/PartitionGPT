    ...
    IERC721Errors
{
    ...
    function _update(
        ...
        (uint64 fromBalance, uint64 toBalance) = _getBalances(from, to);

        uint64 newFromBalance = fromBalance - 1;
        uint64 newToBalance = toBalance + 1;
    ...
    function _getBalance(address addr) private returns (uint64) {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        uint64 newBalance = _getBalance(to) + 1;
