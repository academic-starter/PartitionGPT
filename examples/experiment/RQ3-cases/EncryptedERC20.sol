...
contract EncryptedERC20 is Ownable2Step {
    ...
    function transfer_priv(address sender, address to, uint64 amount) internal virtual returns (bool) {
    ...
    function balanceOf_priv(address wallet) internal view virtual returns (uint64) {
